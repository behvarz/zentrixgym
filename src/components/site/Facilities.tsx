...
export function Facilities() {
  ...
  return (
    <section id="facilities" className="relative py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-xl">
            <span className="text-xs uppercase tracking-[0.18em] sm:tracking-[0.3em] text-primary">{t("fc.kicker")}</span>
          ...
          <p className="text-muted-foreground max-w-md break-words">{t("fc.desc")}</p>
        </div>
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {items.map((it, i) => (
            <motion.div
              ...
              className="group relative glass rounded-2xl p-5 sm:p-7 overflow-hidden hover:border-primary/50 transition-all min-w-0"
            >
              ...
              <h3 className="relative mt-5 text-lg font-semibold break-words">{t(it.t)}</h3>
              <p className="relative mt-2 text-sm text-muted-foreground leading-relaxed break-words">{t(it.d)}</p>
